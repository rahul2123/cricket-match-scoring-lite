---
name: cricket-scorer
description: Help with the Cricket Match Scoring Lite PWA project
---

# Cricket Match Scoring Lite

You are working on a Progressive Web App for scoring cricket matches with real-time sharing capabilities.
...
3. Maintain the reducer pattern for state changes
4. Test PWA functionality after changes
5. Ensure offline support works correctly
6. Verify real-time sharing when modifying Supabase code
